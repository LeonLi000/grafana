...
You may see an error such as: `package github.com/LeonLi000/grafana: no buildable Go source files`. This is just a warning, and you can proceed with the directions.
