...
- [Typescript data source example](https://github.com/LeonLi000/typescript-template-datasource)
- [Simple json data source](https://github.com/LeonLi000/simple-json-datasource)
- [Clock panel](https://github.com/LeonLi000/clock-panel)
- [Pie chart panel](https://github.com/LeonLi000/piechart-panel)
...
New versions of Grafana can sometimes cause plugins to break. Checkout our [PLUGIN_DEV.md](https://github.com/LeonLi000/grafana/blob/master/PLUGIN_DEV.md) doc for changes in
...
- [SDK file in Grafana](https://github.com/LeonLi000/grafana/blob/master/public/app/plugins/sdk.ts)
- [SDK Readme](https://github.com/LeonLi000/grafana/blob/master/public/app/plugins/plugin_api.md)
...
We currently have three different examples that you can fork/download to get started developing your grafana plugin.
 ...
 - [simple-json-datasource](https://github.com/LeonLi000/simple-json-datasource) (small datasource plugin for querying json data from backends)
 - [example-app](https://github.com/LeonLi000/example-app)
 - [clock-panel](https://github.com/LeonLi000/clock-panel)
 - [singlestat-panel](https://github.com/LeonLi000/grafana/blob/master/public/app/plugins/panel/singlestat/module.ts)
 - [piechart-panel](https://github.com/LeonLi000/piechart-panel)
